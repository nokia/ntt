...
//
// The fields mirror vanadium's [tools.fmt] TOML section in spirit; you
// can think of this struct as the public API the LSP, the CLI and the
// per-project manifest all populate.
type Options struct {
