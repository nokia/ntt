...
// This file was generated by robots at 2025-03-29 13:20:13.20466627 +0100 CET m=+0.375409591
...
const (
	...
	//
	// 	[from to] MAPFROMTO [obj]
	//
	MAPFROMTO Opcode = 0x0fc3
...
var Descriptions = map[Opcode]*Descriptor{
	...
	MAPFROMTO: {
		Opcode:      0x0fc3,
		Description: "Build a map type object from the types from and to and push the\nresulting object onto the stack.\n\n",
		Context:     []string{"type_new"},
		Operations: Operation{
			Pre:  []string{"from", "to"},
			Post: []string{"obj"},
