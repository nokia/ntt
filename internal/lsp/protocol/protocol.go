...
func cancelCall(ctx context.Context, conn jsonrpc2.Conn, id jsonrpc2.ID) {
	// NOTE(5nord) I removed some cancelation code, which seemed to be
	// purely related to telemtry. If some calls are not getting canceled,
	// you have maybe come to the right place.
	//
	// I am sorry for that.
