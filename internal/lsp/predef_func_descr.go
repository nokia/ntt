...
var predefinedFunctions = []PredefFunctionDetails{
		...
		TextFormat:     protocol.SnippetTextFormat},
	{
		...
		Signature:      "int2unichar(in integer invalue) return charstring",
		Documentation:  "## (TTCN-3)\nThe __int2unichar__ function ",
		NrOfParameters: 1,
		TextFormat:     protocol.SnippetTextFormat},
	{
		Label:          "int2bit(...)",
		InsertText:     "int2bit(${1:invalue})$0",
		Signature:      "int2bit(in integer invalue) return charstring",
		Documentation:  "## (TTCN-3)\nThe __int2bit__ function ",
		NrOfParameters: 1,
		TextFormat:     protocol.SnippetTextFormat},
	{
		Label:          "int2enum(...)",
		InsertText:     "int2enum(${1:invalue})$0",
		Signature:      "int2enum(in integer invalue) return charstring",
		Documentation:  "## (TTCN-3)\nThe __int2enum__ function ",
		NrOfParameters: 1,
		TextFormat:     protocol.SnippetTextFormat},
	{
		Label:          "int2hex(...)",
